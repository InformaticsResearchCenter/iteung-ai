...
def setEncoderDecoder(VOCAB_SIZE):
    ...
    _, state_h, state_c = LSTM(200, return_state=True, dropout=0.5, recurrent_dropout=0.5)(enc_embedding)
...
factory, stemmer, punct_re_escape, unknowns, file_name, path = setConfig("../lstm")
