...
def setEncoderDecoder(VOCAB_SIZE):
    ...
    enc_outputs, forward_h, forward_c, backward_h, backward_c = Bidirectional(
        LSTM(200, return_state=True, return_sequences=True, dropout=0.5, recurrent_dropout=0.5))(enc_embedding)
...
factory, stemmer, punct_re_escape, unknowns, file_name, path = setConfig("bilstm-bahdanau")
