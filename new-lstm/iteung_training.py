...
from keras.layers import Embedding, LSTM, Dense, Layer
...
enc_outputs, state_h, state_c = LSTM(256, return_state=True, dropout=0.5, recurrent_dropout=0.5)(enc_embedding)
